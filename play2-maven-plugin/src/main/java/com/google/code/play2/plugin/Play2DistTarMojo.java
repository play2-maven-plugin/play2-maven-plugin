...
/**
 * Package Play&#33; framework and Play&#33; application as one Tar achive (standalone distribution).
 * 
 * @author <a href="mailto:gslowikowski@gmail.com">Grzegorz Slowikowski</a>
 * @since 1.0.0
 */
@Mojo( name = "dist-tar", defaultPhase = LifecyclePhase.PACKAGE, requiresDependencyResolution = ResolutionScope.RUNTIME )
public class Play2DistTarMojo
    extends AbstractPlay2DistTarMojo
{
        ...
        throws MojoExecutionException, MojoFailureException, IOException
    {
        ...
        try
        {
            ...
            TarArchiver tarArchiver = prepareArchiver();
            ...
            if ( distAttach )
            {
                projectHelper.attachArtifact( project, "tar.gz", distClassifier, destFile );
            }
