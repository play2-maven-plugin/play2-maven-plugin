...
public class Play22EbeanEnhancer implements Play2EbeanEnhancer
{
    ...
    public void enhance( File applicationConfFile/*String models*/ ) // what about exceptions?
    {
        ...
        Config config = ConfigFactory.load( ConfigFactory.parseFileAnySyntax( applicationConfFile/*new File( "conf/application.conf" )*/ ) );
