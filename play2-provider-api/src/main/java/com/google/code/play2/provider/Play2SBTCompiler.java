...
import org.apache.maven.plugin.logging.Log;//GS-nie podoba mi się to
...
//    String getDefaultScalaVersion();
    ...
    //TODO - parametry ustawiac setterami, compile powinno byc bezparametrowe
    SBTCompilationResult/*Analysis*/ compile( Log mavenLog, File scalaCompilerFile, File scalaLibraryFile, List<File> scalaExtra,
